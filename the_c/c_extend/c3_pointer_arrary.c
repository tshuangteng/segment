 ...
 *
 * 数组名代表数组首元素的地址，是指针常量，不能进行自加自减运算。
 */
...
int main() {
    ...
    int *ptr2 = (int *) ((int) p + 1);  // p 数组名表示数组首元素的地址，是指针常量, 并强制转换为普通的int数值
    ...
    // address of ptr2: 6421889  // (int)p 表示指针指向了数组中的第一个元  ---> 加1, 即就是加字节数1, 为p[0]的第二字节地址.
    //
    // value1: 4
    // value2: 2000000
